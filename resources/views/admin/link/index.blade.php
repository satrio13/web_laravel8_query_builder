                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('backend/tambah-link') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Link</a>
                                    ...
                                    @foreach($data as $no => $r)
                                        <tr>
                                            ...
                                            <td class="text-center" nowrap>
                                                <a href="{{ route('backend/edit-link', $r->id) }}" class="btn btn-info btn-xs" title="EDIT DATA">EDIT</a>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="{{ route('backend/hapus-link', $r->id) }}" title="HAPUS DATA">HAPUS</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
