...
@section('js')
    <script>
            ...
            cek_session(function()
            {
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        var alamatins = data.alamatins ?? '';
                        var hp = data.hp ?? '';
                        var email = data.email ?? '';
                        var alamat = data.alamat ?? '';
                        var kesan = data.kesan ?? '';
        ...
        function save_status()
        {
            cek_session(function()
            {
                $('#btnSave').text('saving...').attr('disabled',true); //set button disable 
                ...
                $.ajax({
                    ...
                    complete: function()
                    {
                        $('#btnSave').html('<i class="fa fa-check"></i> SIMPAN').attr('disabled',false); //set button enable
                    }
                });
            });
        }
