                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('backend/album') }}">Album</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('backend/update-album', $data->id_album) }}" id="form">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" name="album" maxlength="50" value="{{ old('album', $data->album) }}" class="form-control" placeholder="NAMA HALAMAN" required>
                                        <small class="text-danger">
                                            {{ ($errors->first('album')) ? $errors->first('album') : '' }} 
                                        </small>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('backend/album') }}" class="btn btn-danger btn-sm float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
