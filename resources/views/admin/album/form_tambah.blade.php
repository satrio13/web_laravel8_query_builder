            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('backend/simpan-album') }}" id="form">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">NAMA ALBUM <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" name="album" maxlength="50" value="{{ old('album') }}" class="form-control" placeholder="NAMA HALAMAN" required>
