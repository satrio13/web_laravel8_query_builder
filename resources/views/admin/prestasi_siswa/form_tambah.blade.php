                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('backend/prestasi-siswa') }}">Prestasi Siswa</a></li>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('backend/simpan-prestasi-siswa') }}" enctype="multipart/form-data" id="form">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="nama_siswa" maxlength="100" value="{{ old('nama_siswa') }}" class="form-control required" placeholder="NAMA SISWA">
                                        <small class="text-danger">
                                            {{ ($errors->first('nama_siswa')) ? $errors->first('nama_siswa') : '' }}
                                        </small> 
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="kelas" maxlength="6" value="{{ old('kelas') }}" class="form-control" placeholder="KELAS">
                                        <small class="text-danger">
                                            {{ ($errors->first('kelas')) ? $errors->first('kelas') : '' }}
                                        </small> 
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('backend/prestasi-siswa') }}" class="btn btn-danger btn-sm float-right"><i class="fa fa-arrow-left"></i> BATAL</a>
                            </div> 
                        </form>
                    </div>
                    <!-- /.card -->
