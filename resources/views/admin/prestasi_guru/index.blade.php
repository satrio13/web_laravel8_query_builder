                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('backend/tambah-prestasi-guru') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Prestasi Guru</a>
                                ...
                                <table class="table table-bordered table-striped table-sm" id="datatable">
                                    ...
                                    @foreach($data as $no => $r)
                                        @php
                                            ...
                                            if($r->gambar != '' AND file_exists("img/prestasi_guru/$r->gambar"))
                                            {
                                                $img = '<a href="/img/prestasi_guru/'.$r->gambar.'" target="_blank">
                                                            <img src="/img/prestasi_guru/'.$r->gambar.'" class="img img-fluid" width="100px">
                                                        </a>'; 
                                            }else
                                            {
                                                $img = '';
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" nowrap>
                                                <a href="{{ route('backend/edit-prestasi-guru', $r->id) }}" class="btn btn-info btn-xs" title="EDIT DATA">EDIT</a>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="{{ route('backend/hapus-prestasi-guru', $r->id) }}" title="HAPUS DATA">HAPUS</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
