            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('backend/simpan-banner') }}" enctype="multipart/form-data" id="form">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="judul" maxlength="100" value="{{ old('judul') }}" class="form-control" placeholder="JUDUL">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">KETERANGAN</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="keterangan" maxlength="200" value="{{ old('keterangan') }}" class="form-control" placeholder="KETERANGAN">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">LINK</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="link" maxlength="300" value="{{ old('link') }}" class="form-control" placeholder="LINK">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">TULISAN TOMBOL</label>
                                    <div class="col-sm-5">
                                        <input type="text" name="button" maxlength="30" value="{{ old('button') }}" class="form-control" placeholder="TULISAN TOMBOL">
                                    </div>
                                </div>
                                <div class="form-group row">
