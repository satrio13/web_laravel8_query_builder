                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('backend/tambah-agenda') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah Agenda</a>
                                    ...
                                    @foreach($data as $no => $r)
                                        @php
                                            if(strlen($r->keterangan) > 200)
                                            {
                                                ...
                                                $keterangan = substr($r->keterangan,0,strrpos($isi," ")). '... <a href="'.route('agenda/detail', $r->slug).'" target="_blank"><b>Lihat Detail</b></a>';
                                            }else
                                            {
                                            ...
                                            {
                                                $img = '<a href="/img/agenda/'.$r->gambar.'" target="_blank">
                                                            <img src="/img/agenda/'.$r->gambar.'" class="img img-fluid" width="100px">
                                                        </a>'; 
                                            }else
                                            {
                                                $img = '';
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" nowrap>
                                                <a href="{{ route('backend/edit-agenda', $r->id) }}" class="btn btn-info btn-xs" title="EDIT DATA">EDIT</a>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#konfirmasi_hapus" data-href="{{ route('backend/hapus-agenda', $r->id) }}" title="HAPUS DATA">HAPUS</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
