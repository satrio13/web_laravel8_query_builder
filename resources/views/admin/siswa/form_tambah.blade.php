                        ...
                        <form method="POST" action="{{ route('backend/simpan-siswa') }}" id="form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" name="jml1pa" min="0" value="{{ old('jml1pa') }}" class="form-control required" placeholder="JUMLAH SISWA PUTRA" onkeypress="return hanyaAngka(event)">
                                        <small class="text-danger">
                                            {{ ($errors->first('jml1pa')) ? $errors->first('jml1pa') : '' }}
                                        </small>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="number" name="jml1pi" min="0" value="{{ old('jml1pi') }}" class="form-control required" placeholder="JUMLAH SISWA PUTRI" onkeypress="return hanyaAngka(event)">
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" name="jml2pa" min="0" value="{{ old('jml2pa') }}" class="form-control required" placeholder="JUMLAH SISWA PUTRA" onkeypress="return hanyaAngka(event)">
                                        <small class="text-danger">
                                            {{ ($errors->first('jml2pa')) ? $errors->first('jml2pa') : '' }}
                                        </small>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="number" name="jml2pi" min="0" value="{{ old('jml2pi') }}" class="form-control required" placeholder="JUMLAH SISWA PUTRI" onkeypress="return hanyaAngka(event)">
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" name="jml3pa" min="0" value="{{ old('jml3pa') }}" class="form-control required" placeholder="JUMLAH SISWA PUTRA" onkeypress="return hanyaAngka(event)">
                                        <small class="text-danger">
                                            {{ ($errors->first('jml3pa')) ? $errors->first('jml3pa') : '' }}
                                        </small>
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="number" name="jml3pi" min="0" value="{{ old('jml3pi') }}" class="form-control required" placeholder="JUMLAH SISWA PUTRI" onkeypress="return hanyaAngka(event)">
                                        <small class="text-danger">
