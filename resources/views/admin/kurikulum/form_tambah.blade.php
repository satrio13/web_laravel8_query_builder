            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="{{ route('backend/simpan-kurikulum') }}" id="form">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">MATA PELAJARAN <span class="text-danger">*</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" name="mapel" maxlength="50" value="{{ old('mapel') }}" class="form-control required" placeholder="NAMA MATA PELAJARAN">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" name="no_urut" value="{{ old('no_urut') }}" min="0" onkeypress="return hanyaAngka(event)" class="form-control required" placeholder="NO URUT">
                                        <small class="text-danger">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="number" name="alokasi" value="{{ old('alokasi') }}" min="0" onkeypress="return hanyaAngka(event)" class="form-control required" placeholder="ALOKASI WAKTU">
                                        <small class="text-danger">
