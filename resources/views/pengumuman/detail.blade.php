...
<section id="isi" class="pt-3 pb-5">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 text-break">
                <div class="row">
                    @if($data->gambar != '' AND file_exists("img/pengumuman/$data->gambar"))
                        <div class="col-md-12">
                            <a href="/img/pengumuman/{{ $data->gambar }}" class="image-link">
                                <img src="/img/pengumuman/{{ $data->gambar }}" class="img img-fluid">
                            </a>
                        </div>
                    @endif
                    <div class="col-md-12">
