...
<div class="container">
    <div class="row">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-white">
                ...
                <li class="breadcrumb-item"><a href="{{ route('guru') }}">Tenaga Non Edukatif</a></li>
    ...
    @if($data->gambar != '' AND file_exists("img/karyawan/$data->gambar"))
        <div class="row">
            <div class="col-md-12 d-flex justify-content-center">
                <a href="/img/karyawan/{{ $data->gambar }}" class="image-link">
                    <img src="/img/karyawan/{{ $data->gambar }}" class="img img-fluid" width="150px">
                </a>
            </div>
        </div>
    @endif
